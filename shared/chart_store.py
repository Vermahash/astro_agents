...
FIELD_DESCRIPTIONS: dict[str, str] = {
    ...
    "ashtakavarga_sav": "Sarvashtakavarga house bindu scores (1–12)",
    "ashtakavarga_bav": "Bhinna ashtakavarga per-planet bindus",
    "bnn_module": "Bhrigu Nandi Nadi directional groups and yogas",
    "yoga_rule_matrix": "Yoga engine rule-by-rule confirmation matrix",
